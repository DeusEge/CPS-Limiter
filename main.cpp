...
#define appName L"CPS LimiterV8"
#define keyPath "Software\\CPS Limiter"
#define defaultOutputMessage L"CPS LimiterV8 By Deus"
...
LRESULT CALLBACK WindowProcedure(HWND hwnd, UINT msg, WPARAM wp, LPARAM lp) {
	...
	case WM_CREATE: {
		...
		AppendMenu(hSettings, MF_STRING, 1001, TEXT("Sound"));
		AppendMenu(hSettings, MF_STRING, 1002, TEXT("Store Data"));


		AppendMenu(hMenu, MF_POPUP, (UINT_PTR)hCommunication, TEXT("Communication"));
		AppendMenu(hCommunication, MF_STRING, 1111, TEXT("Discord"));
		AppendMenu(hCommunication, MF_STRING, 1112, TEXT("Youtube"));
		AppendMenu(hCommunication, MF_STRING, 1113, TEXT("Github"));

		SetMenu(hwnd, hMenu);
		if (sound) CheckMenuItem(GetMenu(hwnd), 1001, MF_CHECKED);
		if (storeData) CheckMenuItem(GetMenu(hwnd), 1002, MF_CHECKED);
